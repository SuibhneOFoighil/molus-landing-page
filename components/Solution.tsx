        ...
        <div className="flex flex-col md:flex-row justify-between gap-12 md:gap-24 max-w-4xl mx-auto">
          <div className="relative flex-1">
            ...
            >
              <motion.div
                ...
                className="flex items-center justify-center w-6 h-6 rounded-full bg-[#ffda00]"
              >
                <Check className="w-4 h-4 text-black" />
              </motion.div>
              <div className="space-y-2">
                <h3 className="text-4xl md:text-5xl font-bold transition-colors duration-200 group-hover:text-[#e2d210]">$50,000+</h3>
                <p className="text-white/80">In savings for our clients</p>
              </div>
            </motion.div>
            <motion.div
              initial={{ scaleX: 0 }}
          ...
          <div className="relative flex-1">
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-4xl md:text-5xl font-bold transition-colors duration-200 group-hover:text-[#e2d210]">3x Faster</h3>
                <p className="text-white/80">Launch of MVPs compared to traditional development approaches</p>
              </div>
            </motion.div>
            <motion.div
              initial={{ scaleX: 0 }}
